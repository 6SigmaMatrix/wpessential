...
return Section::make( __( 'Color', 'wpessential' ), 'color_field' )
              ->description( __( 'Color fields examples.', 'wpessential' ) )
              ->icon_type( 'icon' )
              ->icon( 'location' )
	...
	->priority( 20 )
              ->controls( [
	              ...
	              Color::make( __( 'Color field in small size', 'wpessential' ) )
	                   ...
	                   ->size( 'small' )
	                   ->toArray(),
	              Color::make( __( 'Color field in default size', 'wpessential' ) )
	                   ->subtitle( __( 'Field Subtitle' ) )
	                   ->description( __( 'Field description' ) )
	                   ->placeholder( __( 'Field placeholder', 'wpessential' ) )
	                   ->size( 'default' )
	                   ->toArray(),
	              Color::make( __( 'Color field in empty size', 'wpessential' ) )
	                   ->subtitle( __( 'Field Subtitle' ) )
	                   ->description( __( 'Field description' ) )
	                   ->placeholder( __( 'Field placeholder', 'wpessential' ) )
	                   ->size( '' )
