...
class PostQuery
{
	...
	public function get_query_args ()
	{
		...
		if ( 'current_query' === $post_type ) {
			 ...
			 *
			 */
			$current_query_vars = apply_filters( 'wpessneital/query/get_query_args/current_query', $current_query_vars );
		...
		$this->query_args = apply_filters( 'wpessneital/query/query_args', $this->query_args, $this->widget );
