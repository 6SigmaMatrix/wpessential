    ...
    <transition name="fade">
        <el-row :gutter="15" type="flex">
            ...
            <el-col class="wpessential-field" :span="v_if_single(field.help,13,16 )">
                <el-select @change="select_change" v-bind="attr" :name="field.id" class="wpessential-form-select" v-model="value">
                    <el-option v-for="(label, key) in field.options" :key="key" :value="key" :label="label"></el-option>
                </el-select>
